				...
				lang: f(function(e) {
					return Ka.test(e ||
						...
						function(c) {
							var a;
							do
								if(a = s ? c.lang : c.getAttribute("xml:lang") || c.getAttribute("lang")) return a = a.toLowerCase(), a === e || 0 === a.indexOf(e + "-"); while ((c = c.parentNode) && 1 === c.nodeType);
							return !1
						}
				}),
				target: function(c) {
		...
		ajax: function(e, f) {
			function l(e, f, q, g) {
				...
				if(2 !== m) {
					...
					a: {
						q = E;u = F;Z = p;ka = g;
						var s, y, ra;F = {};Ca = q.dataTypes.slice();
						if(Ca[1])
		...
		oa("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
			parser: function(a, c, f, b, d, g, q) {
				...
				var v = a.style,
					M = Ta.length,
					w = {};
				if(q.display ? (k = da(a, "display"), v.display = "block", h = Va(a, p, !0, q.parseTransform), v.display = k) : h = Va(a, p, !0, q.parseTransform), b._transform = h, "string" == typeof q.transform && za) k = ja.style, k[za] = q.transform, k.display = "block", k.position = "absolute", V.body.appendChild(ja), l = Va(ja, null, !1), h.svg && (t = h.xOrigin, u = h.yOrigin, l.x -= h.xOffset, l.y -= h.yOffset,
					(q.transformOrigin || q.svgOrigin) && (m = {}, cb(a, Z(q.transformOrigin), m, q.svgOrigin, q.smoothOrigin, !0), t = m.xOrigin, u = m.yOrigin, l.x -= m.xOffset - h.xOffset, l.y -= m.yOffset - h.yOffset), (t || u) && (A = ib(ja), l.x -= t - (t * A[0] + u * A[2]), l.y -= u - (t * A[1] + u * A[3]))), V.body.removeChild(ja), l.perspective || (l.perspective = h.perspective), null != q.xPercent && (l.xPercent = pa(q.xPercent, h.xPercent)), null != q.yPercent && (l.yPercent = pa(q.yPercent, h.yPercent));
