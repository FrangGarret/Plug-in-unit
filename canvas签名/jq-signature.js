...
//      });
        ...
        $(document).on("click", "#myBackColor", null, function () {
            ...
            $('#colorpanel').css('left', '95px').css('bottom', '45px').css("display", "block").fadeIn();
            //$("canvas").css("background", "#EEEEEE");
            $("#btnSave").data("sender", "#myBackColor");
        });

        $(document).on("click", "#myColor", null, function () {
            $('#colorpanel').css('left', '10%').css('bottom', '45px').css("display", "block").fadeIn();
                ...
                '<div class="modal-content">' +
                    ...
                    '<div class="modal-body">' +
                        '<div class="js-signature" id="mySignature">' +
                         ...
                         '<div id="colorpanel" style="position:fixed;z-index:99;display:none"></div>' +
    ...
    function initTable() {
        ...
        '<td width="3"><input type="text" name="HexColor" size="7" style="border:inset 1px;font-family:Arial;" value="#000000"></td>' +
         '<td width="3"><button type="button" class="btn questions_enter btn-primary btn-sm" id="btnSave">确认</button></td>' +
        '</tr>' +
        '</table>' +
